...
func (c *Container) update(updateOptions *entities.ContainerUpdateOptions) error {
	if updateOptions.Resources == nil && updateOptions.RestartPolicy == nil && updateOptions.Rlimits == nil {
		return fmt.Errorf("must provide at least one of resources, restartPolicy, or rlimits to update a container: %w", define.ErrInvalidArg)
	}
